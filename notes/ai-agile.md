...
__første tankerekke__

Hei alle!

Jeg heter Petter. Jobber som Nille-Sigurd i Haugesund.

Jeg jobber i skjæringspunktet mellom teknologi og folk og komersielle vurderinger. Både ute hos kunde, og her hjemme i Miles. Det er det siste jeg har lyst til å snakke om. 
...
bakgrunn: 
    to hester, unsplash. https://images.unsplash.com/photo-1608373992064-1afe0644d212?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D
...
# The Race
backgrund: 
    - Photo by <a href="https://unsplash.com/@edo_labar_foto?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Eduard Labár</a> on <a href="https://unsplash.com/photos/people-riding-horses-on-green-grass-field-during-daytime-9lOrwiZ3W4k?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
      
notes: 
    i følge Antropics CEO, tjener de penger på hver individuelle modell, men taper totalt sett penger fordi de totalt    sett bruker mye mer på den _neste_ modellen, enn de gjore på den forrige.


# Skygge-IT
background: Photo by <a href="https://unsplash.com/@jankolar?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Jan Antonin Kolar</a> on <a href="https://unsplash.com/photos/two-human-shadows-in-pavement-bEsrzyK3eFA?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>

notes: 
    - Det er _alltid_ Skygge-IT
    - jo kraftigere og bedre verktøyene er, jo større er sjansen for at det blir tatt inn.
    - I følge Gartner: 80% av ansatte bruker noen form for skygge-IT gjennom arbeidsdagen.
    - oppmot 50% av applikasjoner brukt i virksomheter er ikke styrt gjennom IT.
    - Min take-away: Enten bygger vi en ryddig rigg for Agentiske verktøy i våre prosjekter, ellers lar vi utviklere kjøre cowboy-løp selv.

# En historie om en omskriving
bakgrunn: kraftplugg.
tekst: "Te, Tegning og Tenking"
undertekst: "tre utviklere, en uke, 12 linjer kode"
